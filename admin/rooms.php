          ...
          <div class="modal-body" style="color: black; text-align: left">
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="rtype" class="form-control shadow-none" required />
              </div>
              ...
              <div class=" col-12 mb-3">
                ...
                <textarea name="gmap" class="form-control shadow-none" rows="4" placeholder="Enter the embedded iframe tag from google map" require></textarea>
              </div>
                  ...
                  <div class="modal-body" style="color: black; text-align: left">
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-3">
                       ...
                       <div class=" col-12 mb-3">
                        <label class="form-label">Google Map</label>
                        <textarea name="gmap" class="form-control shadow-none" rows="4" require></textarea>
                      </div>
