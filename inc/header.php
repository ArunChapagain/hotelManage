    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        if (isset($_SESSION['login']) && $_SESSION['login'] == true) {
          echo <<<data
                   <div class="dropdown">
                    <a class="btn btn-outline-dark dropdown-toggle shadow-none pop" type="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                    $_SESSION[uName]
                    </a>
                  
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                      <li><a class="dropdown-item bg-light text-dark" href="profile.php">Profile</a></li>
                      <li><a class="dropdown-item bg-light text-dark" href="bookings.php">Booking</a></li>
                      <li><a class="dropdown-item bg-light text-dark" href="logout.php">logout</a></li>
                    </ul>
                  </div>
                  <a type="button" class="btn btn-outline-dark shadow-none mt-3 mx-3 me-lg-3 me-2 text-center" href="logout.php">
                    Logout
                  </a>
                  data;
        } else {
    ...
    <div class="modal-content">
      <form id="login-form">
        <div class="modal-header">
          <h5 class="modal-title d-flex align-items-center" style="color:black;"><i
          ...
          <div class="container-fluid">
            <div class="row d-flex">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="file" accept=".jpg,.png,jpeg,.webp" name="profile" class="form-control shadow-none"
                  required>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">Document Image</label>
                <input type="file" accept=".jpg,.png,jpeg,.webp" name="document" class="form-control shadow-none"
                  required>
              </div>
              <div class="col-md-6 mb-3">
